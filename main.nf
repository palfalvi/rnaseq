...
include { rsem_idx } from './modules/rsem_idx.nf'
include { rsem } from './modules/rsem.nf'
include { minimap2 } from './modules/minimap2.nf'
include { minimap2_idx } from './modules/minimap2_idx.nf'
...
*/
  ...
  if ( params.reads ) {
    ...
    Channel
      .fromFilePairs( params.reads, size: assert (params.single || params.ont) ? 1 : 2 )
